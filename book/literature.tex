...
\bibitem{SIAM} TODO: ссылка на статью SIAM, 2014.

\bibitem{Kalitkin_Ritus_Smooth_App_Preprint} Калиткин Н.Н., Ритус И.В. Гладкие аппроксимации функций Ферми–Дирака. М.: ИПМ им. М. В. Келдыша, 1981, препринт №72, 9с.;
...
\bibitem{Kalitkin_Ritus_Smooth_App_Zhvm} Калиткин Н.Н., Ритус И.В. Гладкая аппроксимация функций Ферми–Дирака // Журнал вычислительной математики и математической физики, 1986, т.26, №3, с.461-464.
...
\bibitem{Kolganov_Master_Disser} Колганов С.А., Аппроксимации функций Ферми-Дирака полуцелого индекса, маг. дисс., Москва, НИУ МИЭТ, 2017.
